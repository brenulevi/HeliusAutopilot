...
/*
 * CMSIS backend skeleton.
 *
 * TODO: Replace scalar fallback paths with CMSIS-DSP calls (arm_mat_* / arm_dot_prod_f32)
 * once CMSIS-DSP is linked and validated for the STM32 target.
 */
